...
void EXTI0_IRQHandler_impl(void);//__attribute__((interrupt("WCH-Interrupt-fast")));
void EXTI1_IRQHandler(void) __attribute__((naked));
void EXTI1_IRQHandler_impl(void);// __attribute__((interrupt("WCH-Interrupt-fast")));
void EXTI3_IRQHandler(void) __attribute__((naked));
void EXTI3_IRQHandler_impl(void);//; __attribute__((interrupt("WCH-Interrupt-fast")));
void EXTI4_IRQHandler(void) __attribute__((naked));
void EXTI4_IRQHandler_impl(void);// __attribute__((interrupt("WCH-Interrupt-fast")));
void EXTI9_5_IRQHandler(void) __attribute__((naked));
void EXTI9_5_IRQHandler_impl(void);//; __attribute__((interrupt("WCH-Interrupt-fast")));


void EXTI0_IRQHandler(void)
{
  __asm volatile ("call EXTI0_IRQHandler_impl; mret");
}

void EXTI0_IRQHandler_impl(void)
{
    GET_INT_SP();
    rt_interrupt_enter();
...
{
  __asm volatile ("call EXTI1_IRQHandler_impl; mret");
}

void EXTI1_IRQHandler_impl(void)
{
    GET_INT_SP();
    rt_interrupt_enter();
...
{
  __asm volatile ("call EXTI2_IRQHandler_impl; mret");
}

void EXTI2_IRQHandler_impl(void)
{
    GET_INT_SP();
    rt_interrupt_enter();
...
{
  __asm volatile ("call EXTI3_IRQHandler_impl; mret");
}


void EXTI3_IRQHandler_impl(void)
{
    GET_INT_SP();
    rt_interrupt_enter();
...
{
  __asm volatile ("call EXTI4_IRQHandler_impl; mret");
}
...
{
  __asm volatile ("call EXTI9_5_IRQHandler_impl; mret");
}
void EXTI9_5_IRQHandler_impl(void)
{
    GET_INT_SP();
    rt_interrupt_enter();
